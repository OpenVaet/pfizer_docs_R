...
for(i in 1:length(trs)){
  ...
  if(length(tds) > 0){
    ...
    if(file_name == '125742_S1_M5_5351_c4591001 fa interim discontinued patients.pdf'){
      ...
      for (line in lines) {
        ...
        # Stops printing when line exactly matches "16.2.1.6"
        if (grepl("16\\.2\\.1\\.6", line)) {
          to_print <- 0
        }
