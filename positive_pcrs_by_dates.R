...
# Creates the first chart for bnt_data
ggplot(bnt_central_pcrs_pos_by_days_from_start, aes(x = DAYSFROMSTART, y = cum_unique_SUBJID)) + 
  geom_line() + 
  labs(x = "Days from Start", y = "Cumulative Number of Tests", title = "C4591001 - Positive PCRs for BNT162b2 Phase 2/3 (30 mcg) to November 14, 2020") + 
  geom_line(color = "blue", linewidth = 1.2) + 
  theme_minimal() +
  theme(text = element_text(size = 18),
        axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))

# Creates the second chart for placebo_data
ggplot(placebo_central_pcrs_pos_by_days_from_start, aes(x = DAYSFROMSTART, y = cum_unique_SUBJID)) + 
  geom_line() + 
  labs(x = "Days from Start", y = "Cumulative Number of Tests", title = "C4591001 - Positive PCRs for Placebo to November 14, 2020") + 
...
# Creates the first chart for bnt_data
ggplot(bnt_central_pcrs_pos_by_days_from_start_with_symptoms, aes(x = DAYSFROMSTART, y = cum_unique_SUBJID)) + 
  geom_line() + 
  labs(x = "Days from Start", y = "Cumulative Number of Tests", title = "C4591001 - Positive PCRs for BNT162b2 Phase 2/3 (30 mcg) to November 14, 2020") + 
  geom_line(color = "blue", linewidth = 1.2) + 
  theme_minimal() +
...
# Creates the second chart for placebo_data
ggplot(placebo_central_pcrs_pos_by_days_from_start_with_symptoms, aes(x = DAYSFROMSTART, y = cum_unique_SUBJID)) + 
  geom_line() + 
  labs(x = "Days from Start", y = "Cumulative Number of Tests", title = "C4591001 - Positive PCRs for Placebo to November 14, 2020") + 
  geom_line(color = "red", linewidth = 1.2) + 
  theme_minimal() +
...
symptomatic_pcr_template <- gsub("P_VALUE", format.pval(no_visit_3_chi_sq$p.value, digits = 4), symptomatic_pcr_template)
...
# Creates the first chart for bnt_data
ggplot(bnt_central_pcrs_pos_by_days_from_start_with_symptoms_merged, aes(x = DAYSFROMSTART, y = cum_unique_SUBJID)) + 
  geom_line() + 
  labs(x = "Days from Start", y = "Cumulative Number of Tests", title = "C4591001 - Positive PCRs for symptomatic BNT162b2 Phase 2/3 (30 mcg) from Dose 1 to November 14, 2020") + 
  geom_line(color = "blue", linewidth = 1.2) + 
  theme_minimal() +
  theme(text = element_text(size = 18),
        axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
...
# Creates the second chart for placebo_data
ggplot(placebo_central_pcrs_pos_by_days_from_start_with_symptoms_merged, aes(x = DAYSFROMSTART, y = cum_unique_SUBJID)) + 
  geom_line() + 
  labs(x = "Days from Start", y = "Cumulative Number of Tests", title = "C4591001 - Positive PCRs for symptomatic Placebo from Dose 1 to November 14, 2020") + 
  geom_line(color = "red", linewidth = 1.2) + 
  theme_minimal() +
  theme(text = element_text(size = 18),
        axis.text.x = element_text(angle = 90, hjust = 1, vjust = 0.5))
